...
- `trace`: 读取抖音作品 7682765064264305966 的公开页面与多个时间点画面，观察开头、人物讲解段、关系节点和素材插入段；对照现有 `voice-studio`、`video-script` 与 `review_export.py`。
...
- artifact：本次SKILL.md与visual-language、beat-template、production-gates修订；样片位于 <pilot-sample-path> 。样片不是30秒规则的端到端验证。
